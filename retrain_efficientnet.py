...
model_path = "./model/EfficientNet-B0_discard_6_batch64_epoch5_LDAM_sgd_aug_tensorboard_best_f1"
...
model = mixed_precision_train_with_tensorboard(model_name, dataloaders, model, criterion, optimizer, exp_lr_scheduler,dataset_size, num_epochs=2, device=device)
