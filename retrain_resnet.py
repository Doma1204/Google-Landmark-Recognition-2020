...
model_path = "./model/Resnet50_discard_6_batch64_epoch5_LDAM_sgd_aug_tensorboard_best_f1"
model_name = "Resnet50_discard_6_batch64_epoch5_LDAM_sgd_aug_tensorboard"

print("Retrain Model: " + model_name)
...
model = mixed_precision_train_with_tensorboard(model_name, dataloaders, model, criterion, optimizer, exp_lr_scheduler,dataset_size, num_epochs=3, device=device)
